...
def ler_dados_arquivo(arquivo_csv):
    ...
    dados = np.genfromtxt(arquivo_csv, delimiter=',', skip_header=1, dtype=str)
     ...
     # Verifica se há dados na matriz
    if dados.ndim == 1:
        print("Erro: O arquivo CSV contém apenas uma linha ou está vazio.")
        return None, None
...
X_train, X_test, y_train, y_test = train_test_split(
    X, y_encoded, test_size=0.1, random_state=57)#57#401
#95#53
...
nome_arquivo = 'resultados/m-kNN.csv'
